				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm">
							<img class="card-img-top figure-img img-fluid rounded" src="storage/{{ $post->arquivo }}" alt="Imagem da postagem">
							<div class="card-body">
								...
								<div class="d-flex justify-content-between align-items-center">
									<div class="btn-group">
										...
										<form method="POST" action="/{{ $post->id }}">
											...
											<button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Deseja mesmo excluir o registro?');">Apagar</button>
										</form>
									</div>
								</div>
							</div>
